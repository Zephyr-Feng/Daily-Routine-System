...
void TaskDialog::setupUI()
{
    ...
    m_startYear = new QSpinBox();
    m_startYear->setRange(2026, 2030);
    m_startMonth = new QSpinBox();
    m_startMonth->setRange(1, 12);
    m_startDay = new QSpinBox();
    m_startDay->setRange(1, 31);
    m_startHour = new QSpinBox();
    m_startHour->setRange(0, 23);
    m_startMinute = new QSpinBox();
    m_startMinute->setRange(0, 59);

    // 默认设为当前时间
    m_startYear->setValue(2026);
    m_startMonth->setValue(7);
    m_startDay->setValue(28);
    m_startHour->setValue(16);
    ...
    m_remindYear = new QSpinBox();
    m_remindYear->setRange(2026, 2030);
    m_remindMonth = new QSpinBox();
    m_remindMonth->setRange(1, 12);
    m_remindDay = new QSpinBox();
    m_remindDay->setRange(1, 31);
    m_remindHour = new QSpinBox();
    m_remindHour->setRange(0, 23);
    m_remindMinute = new QSpinBox();
    m_remindMinute->setRange(0, 59);

    // 默认提醒时间 = 开始时间前5分钟
    m_remindYear->setValue(2026);
    m_remindMonth->setValue(7);
    m_remindDay->setValue(28);
    m_remindHour->setValue(15);
